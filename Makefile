...
kernel: kernel_dir/kernel.c kernel_dir/drivers/screen.c kernel_dir/lib/string.c kernel_dir/lib/stdio.c kernel_dir/lib/stdlib.c
...
linker: linker.ld boot.o kernel.o screen.o string.o stdio.o stdlib.o
	ld -m elf_i386 -T linker.ld -o $(BIN) boot.o kernel.o screen.o string.o stdio.o stdlib.o
