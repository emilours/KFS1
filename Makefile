...
kernel: kernel_dir/kernel.c kernel_dir/drivers/screen.c kernel_dir/drivers/keyboard.c kernel_dir/lib/string.c
...
linker: linker.ld boot.o kernel.o screen.o string.o keyboard.o
	ld -m elf_i386 -T linker.ld -o $(BIN) boot.o kernel.o screen.o string.o keyboard.o
